...
namespace DigitalRubyShared
{
    ...
    public struct GestureTouch : IDisposable, IComparable<GestureTouch>
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="platformSpecificId">Platform specific id</param>
    ...
    public class GestureRecognizer : IDisposable
    {
        ...
        private GestureRecognizer failGesture;
        private readonly HashSet<GestureRecognizer> simultaneousGestures = new HashSet<GestureRecognizer>();
        ...
        private void FailGestureNow()
        {
            ...
            if (failGesture != null)
            {
                if (failGesture.state == GestureRecognizerState.EndPending)
                {
                    failGesture.SetState(GestureRecognizerState.Ended);
                }
            }
        }
        ...
        protected virtual void StateChanged()
        {
            if (OnUpdated != null)
            {
                OnUpdated(this, currentTouches);
            }

            if (failGesture != null && (state == GestureRecognizerState.Began || state == GestureRecognizerState.Executing ||
                state == GestureRecognizerState.Ended))
            {
                failGesture.FailGestureNow();
            }
        }
        ...
        {
            activeGestures.Remove(this);
            foreach (GestureRecognizer r in simultaneousGestures)
            {
                DisallowSimultaneousExecution(r);
            }
            if (failGesture != null && failGesture.requireGestureRecognizerToFail == this)
            {
                failGesture.requireGestureRecognizerToFail = null;
            }
        }
        ...
        /// </summary>
        public event GestureRecognizerUpdated OnUpdated;
        ...
        public GestureRecognizer RequireGestureRecognizerToFail
        {
            ...
            set
            {
                if (value != requireGestureRecognizerToFail)
                {
                    ...
                    {
                        requireGestureRecognizerToFail.failGesture = null;
                    }
                    requireGestureRecognizerToFail = value;
                    if (requireGestureRecognizerToFail != null)
                    {
                        requireGestureRecognizerToFail.failGesture = this;
                    }
                }
            }
        }
